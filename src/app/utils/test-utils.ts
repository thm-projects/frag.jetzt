...
export const generateRandomUUID = () => {
  const randomHexString1 = Math.random().toString(16).substring(2).padEnd(14, '0');
  const randomHexString2 = Math.random().toString(16).substring(2).padEnd(14, '0');
  const randomHexString3 = Math.random().toString(16).substring(2).padEnd(14, '0');
  return [
