...
//         str += `${key}: Missing ${this.languages
...
//       }
//     });
//     const result = Object.keys(notTranslated).reduce(
//       (acc, key) => {
...
//     };
//     this.languages.forEach((lang) =>
//       prepareFunction(this.#read(lang), "", lang)
//     );
//   }
//
//   #read(lang) {
//     return JSON.parse(
//       fs.readFileSync(this.directory + lang + ".json", {
//         encoding: "utf8",
//       })
//     );
//   }
...
//   exec(
//     'grep --include=\\*.html --include=\\*.ts --exclude=\\*.spec.ts -ohr "' +
//       filename +
//       "\" -e \"'[^']\\+'\"",
//     (err, stdout, stderr) => {
//       stdout.split("\n").forEach((e) => {
